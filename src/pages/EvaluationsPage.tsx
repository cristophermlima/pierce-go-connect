            ...
            <Tabs defaultValue="eventos" className="w-full">
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex gap-3">
                  ...
                  <Button className="bg-gradient-to-r from-piercing-purple to-piercing-pink">Adicionar Avaliação</Button>
                </div>
              </div>
...
function EventCard({ title, type, image, location, rating, reviews, technicalRating, ethicalRating, diplomaticRating }: EventCardProps) {
  return (
...
function SupplierCard({ title, type, image, location, rating, reviews }: SupplierCardProps) {
  return (
    <Card className="overflow-hidden border-border/30 bg-card/80 backdrop-blur-sm">
      <div className="relative h-48 bg-muted">
        <img src={image} alt={title} className="w-full h-full object-cover" />
